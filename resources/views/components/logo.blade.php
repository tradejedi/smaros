...
<a href="{{ $link }}" class="flex items-center">
    <span :class="{ 'hidden': !isCollapsed }"><svg fill="#000000" class="w-6 h-6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <span :class="{ 'hidden': isCollapsed }" class="dark:text-white text-black text-xl font-bold">{{ $logoText }}</span>
</a>
